...
That is not a declaration. It is a message:

\begin{center}
\ct|subclass:instanceVariableNames:classVariableNames:poolDictionaries:category:|
\end{center}

\noindent sent to the class \ct{Object}, which is an object, and which responds
by building a new class and installing it in \ct{Smalltalk}. Evaluating the same expression in a workspace does the
