...
The compiler \emph{inside} the image is 1983's and has no closures at all,
so \ct{Compiler evaluate:} in a workspace still builds \ct{BlockContext}
objects with the 1983 restrictions.
\end{stnote}
