...
\ct{Stream>>collect:} and the other collection-protocol methods are not
implemented on streams---\ct!(ReadStream on: #(1 2 3)) collect: [:x | x]! is
a doesNotUnderstand. Read into a collection first, or use \ct{do:}.
