...
Every row moves together whenever \ct{lib/} gains tests, because every profile
there requires \ct{st2026} and so inherits its suites. A row that moved by a
different amount from the others would be the interesting case.
