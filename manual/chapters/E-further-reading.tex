...
\item[\emph{Smalltalk-80: The Interactive Programming Environment},] Goldberg,
  ...
  Part~IV of this manual. If the Browser or the Debugger puzzles you, this is
  where the answer is.
...
\ctp{lib/Concurrency/} & \ctp{Mutex}, \ctp{Monitor}, \ctp{SharedQueue},
  \ctp{Promise}, \ctp{LibraryLocks}, and the replacements for what 1983 shared
  without a lock. The class comments explain the design decisions and name
  the fault each was written for\\
