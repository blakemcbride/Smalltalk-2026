...
in. They are checked in as \ct{tutorial/examples/TutorialExamples.class.st},
and \ct{make verify} in the \ct{tutorial} directory re-runs them all. Where
