...
The \ct{README} shows \ct{-manifest sources/MANIFEST}, which builds the pure
1983 system: no exceptions, no closures, no \ct{Mutex}. Use
\ct{-profile profiles/st2026.profile} instead unless you specifically want the
museum piece. Everything in Parts II, V and VI of this book needs the
\ct{st2026} profile.
\end{stwarn}
