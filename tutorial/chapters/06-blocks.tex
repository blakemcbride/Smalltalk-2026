...
profile in \ct{profiles/} except \ct{bluebook} selects. On the command line,
\ct{-closures} does the same for \ct{-eval}. If you build with
\ct{-manifest sources/MANIFEST} you get the 1983 dialect, where blocks are
\ct{BlockContext} objects with the 1983 restrictions.
\end{stnote}
