...
\toprule
red & left & select\\
yellow & middle & the view's menu --- what you can do to the contents\\
blue & right & the window's menu --- what you can do to the window\\
\bottomrule
\end{tabular}
\end{center}
...
Every one of these that opens a window then asks you to frame it: press red,
drag out a rectangle, release.

\section{The window menu}

Blue, anywhere over a window:
...
Press red and drag. Two shortcuts worth having:
...
(128 blue, 129 yellow, 130 red), \ct{k} types a key, \ct{w N} waits N bytecode
