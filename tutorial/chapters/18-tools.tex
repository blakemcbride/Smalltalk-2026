...
\emph{definition} --- the \ct{subclass:} \ldots{} \ct{category:} expression of
Chapter~\ref{ch:classes}.
...
Each list pane has its own middle-button menu.
...
The list fills with matching files. Selecting one and choosing \ct|get contents| from the middle-button menu shows it in the bottom pane. The file menu is
